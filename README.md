...
> **Note:** The `id` field is auto-generated by Hibernate using `@UuidGenerator`. You do not need to include an `id` when creating an order — it will be assigned automatically on insert.
